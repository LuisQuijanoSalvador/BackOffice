...
class Facturacionserv extends Component
{
    ...
    public $idRegistro,$idMoneda=1,$tipoCambio,$fechaEmision,$detraccion=0,$glosa="",$descripcion="",$idCliente,
            ...
            $totalTotal = 0, $startDate, $endDate, $cod01;
    protected $servicios=[];
        ...
        $dataToSend = [
            ...
            "items" => [
                ...
                [
                    ...
                    "codigo_tributo" => "9998",
                    "is_anticipo" => 0,
                    "valorunitbruto" => round($comprobante->inafecto,2), // - $comprobante->otrosImpuestos,2),
                    "valorunit" => round($comprobante->inafecto,2), // - $comprobante->otrosImpuestos,2),
                    "valorventabruto" => round($comprobante->inafecto,2), // - $comprobante->otrosImpuestos,2),
                    "valorventa" => round($comprobante->inafecto,2), // - $comprobante->otrosImpuestos,2),
                    "preciounitbruto" => $comprobante->inafecto,//$comprobante->total,
                    "preciounit" => $comprobante->inafecto,//$comprobante->total,
                    "precioventa" => $comprobante->inafecto,//$comprobante->total,
                    "precioventabruto" => $comprobante->inafecto,//$comprobante->total,
                    ...
                    "otrostributos_monto" => "0.00", // $comprobante->otrosImpuestos,
                    "otrostributos_base" => "0.00", // $comprobante->otrosImpuestos,
                    "placavehiculo" => "",
                    "tot_impuesto" => "0.00",
                    "tipo_operacion" => "OP_INA",
                    "opt_tipodoi"  => "",
