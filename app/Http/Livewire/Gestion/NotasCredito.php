        ...
        $dataToSend = [
            ...
            "items" => [
                [
                    ...
                    "preciounitbruto" => round($comprobante->total,2),
                    "preciounit" => round($comprobante->total,2),
                    "precioventa" => round($comprobante->total,2),
                    "precioventabruto" => round($comprobante->total,2),
                    "igv" => round($comprobante->igv,2),
                    "porc_igv" => "18.00",
                    "isc" => "0.00",
                    "porc_isc" => "0.00",
    ...
    public function enviaCPEMixto($comprobante){
        ...
        $dataToSend = [
            "cabecera" => [
                ...
                "cajero"=> "",
                "nro_transaccion"=> "",
                "orden_compra"=> $comprobante->cod01,
                "glosa"=> $comprobante->numeroFile,
                "glosa_refe"=> "",
                "glosa_pie_pagina"=> $this->glosa,
                "mensaje"=> "",
                ...
                "op_exportacion"=> "0.00",
                "op_exonerada"=> 0.00,
                "op_inafecta"=> round($comprobante->inafecto, 2),
                "op_gravada"=> round($comprobante->afecto, 2),
                // "op_gravada"=> round($comprobante->total / 1.18, 2),
                // "tot_valorventa"=> round($comprobante->total / 1.18, 2),
                "tot_valorventa"=> round($comprobante->afecto + $comprobante->inafecto,2),
                "tot_precioventa"=> round($comprobante->total, 2),
                "isc"=> "0.00",
                // "igv"=> $comprobante->total - round($comprobante->total / 1.18, 2),
                "igv"=> round($comprobante->igv,2),
                "porc_igv"=> "18.00",
                "igv_gratuita"=> "0.00",
                "importe_total"=> round($comprobante->total, 2),
                "total_pagar"=> round($comprobante->total, 2),
                "redondeo"=> "0.00",
                "total_otros_tributos"=> round($comprobante->otrosImpuestos, 2),
                "total_otros_cargos"=> 0,
                "cargodesc_motivo"=> "",
                "cargodesc_base"=> "0.00",
                "porc_dsctoglobal"=> "0.00",
            ...
            "items" => [
                [
                    ...
                    "codigo_tributo" => "1000",
                    "is_anticipo" => 0,
                    "valorunitbruto" => round($comprobante->total / 1.18, 2),
                    "valorunit" => round($comprobante->total / 1.18, 2),
                    "valorventabruto" => round($comprobante->total / 1.18, 2),
                    "valorventa" => round($comprobante->total / 1.18, 2),
                ...
                [
                    ...
                    "valorunitbruto" => "0.00",
                    "valorunit" => "0.00",
                    "valorventabruto" => "0.00",
                    "valorventa" => "0.00",
                    "preciounitbruto" => "0.00",
                    "preciounit" => "0.00",
                    "precioventa" => "0.00",
                    "precioventabruto" => "0.00",
                    "igv" => 0,
                    "porc_igv" => "18.00",
                    "isc" => "0.00",
                    "porc_isc" => "0.00",
