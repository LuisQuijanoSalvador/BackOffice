<div>
    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm p-4">
            <form wire:submit.prevent="updateCompra"> {{-- CAMBIAMOS saveCompra por updateCompra --}}
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%;">Acciones</th> {{-- Aumentamos el ancho para los 2 botones --}}
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($detalles as $index => $detalle)
                                    <tr wire:key="detalle-row-{{ $index }}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info me-1" wire:click="openEditDetalleModal({{ $index }})" title="Editar Detalle">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </button>
                                            <button type="button" wire:click="removeDetalle({{ $index }})" class="btn btn-danger btn-sm" title="Eliminar Detalle">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">
                        Actualizar Compra {{-- CAMBIAMOS "Guardar Compra" por "Actualizar Compra" --}}
                    </button>
                </div>
            </form>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="saveOrUpdateDetalle"> {{-- CAMBIAMOS addDetalleToCompra por saveOrUpdateDetalle --}}
                            <div class="mb-3">
    ...
    <script>
        ...
        Livewire.on('no-detalles-error', () => {
            ...
            if (detalleSection) {
                ...
                detalleSection.classList.add('border', 'border-danger');
                setTimeout(() => {
