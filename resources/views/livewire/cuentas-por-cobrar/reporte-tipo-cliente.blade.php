<div>
    ...
    <div class="contenedorFiltro">
        <div class="row">
            ...
            <div class="col-md-3">
                <label for="selectedTipoCliente">Tipo Cliente:</label>
                <select name="selectedTipoCliente" style="width: 100%; display:block;font-size: 0.9em; height:31px;" class="rounded" id="cboTipoCliente" wire:model.lazy.defer="idTipoCliente">
                    <option value="">-- Buscar Tipo Cliente --</option>
            ...
            <div class="col-md-3">
                <label for="selectedTipoFacturacion">Tipo Facturación:</label>
                <select name="selectedTipoFacturacion" style="width: 100%; display:block;font-size: 0.9em; height:31px;" class="rounded" id="cboTipoFacturacion" wire:model.lazy.defer="idTipoFacturacion">
